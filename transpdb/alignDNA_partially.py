...
def generate_chain(dna_seq, structure, chain_name, res_A, res_T, res_C, res_G):
...
if __name__ == "__main__":
    ...
    # DNA sequence is inputed by user
    ...
    structure_A = generate_chain(dna_seq, structure, 'A', chain_A_res_A, chain_A_res_T, chain_A_res_C, chain_A_res_G)

    # generate the B chain
    ...
    structure_B = generate_chain(reverse_dna_seq, structure, 'A', chain_B_res_A, chain_B_res_T, chain_B_res_C, chain_B_res_G)

    # # merge A and B
    # structure = structure_A
    # structure[0].add(structure_B[0]['B'])
